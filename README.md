...
## การมีส่วนร่วม
- สร้าง issue หรือ pull request หากต้องการเพิ่มฟีเจอร์หรือแก้บั๊ก

## ใบอนุญาต
โปรเจคนี้ใช้ใบอนุญาต MIT (หรือปรับตามต้องการ)

## ติดต่อ
- หากมีคำถามหรือข้อเสนอแนะ โปรดเปิด issue หรือติดต่อผู้พัฒนาใน repo นี้
